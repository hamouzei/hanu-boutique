...
export const FEATURED_PRODUCTS: Product[] = [
  {
    ...
    images: ['/images/products/gown-1.jpg', '/images/products/gown-2.jpg'],
  ...
  },
  {
    ...
    images: ['/images/products/coat-1.jpg', '/images/products/coat-2.jpg'],
...
export const ALL_PRODUCTS: Product[] = [
  ...FEATURED_PRODUCTS,
  {
    ...
    images: ['/images/products/leather-1.jpg'],
